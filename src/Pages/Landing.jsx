        ...
        <div className="w-full xl:max-w-[1280px] mt-12  grid sm:grid-cols-[1fr,1fr] gap-6 ">
          <div className="flex flex-col gap-4 justify-start w-full">
            ...
            <p className="font-inter leading-normal text-light_gray_color text-[1rem]">
              ...
              premier online tool for crafting stunning one-pagers that
              captivate, inform, and leave a lasting impression. Whether you're
              an entrepreneur, a creative professional, a freelancer, or simply
