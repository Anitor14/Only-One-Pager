...
export const UploadTemplate = () => {
  return (
    <div className="flex  flex-col items-start gap-[20px]">
      ...
      {/* <div className="w-full flex-col   md:flex-row flex items-center justify-evenly">
        <div className="flex flex-col  items-start w-full">
          ...
          <div className="invisible flex w-full items-center gap-[16px]">
            ...
            <div className="border-[1px] w-full rounded-[8px] py-[7px] px-[1px]">
              <p className="flex text-[#8f8f8f] text-[14px] justify-center">
        ...
        <div className="flex max-w-[386px] w-full flex-col items-start gap-[20px]">
          <div className="w-full h-[211px] flex flex-col items-center justify-center rounded-[8px] border-[1px] border-[#DADADA] bg-[#FFF] gap-[10px]">
            <div className="flex flex-col items-center gap-[10px]">
              <img src={frame} alt="" />
              <p className="text-[#8f8f8f] text-center font-inter text-[14px] leading-normal">
                Drag and drop your images
              </p>
            </div>
          </div>

          <div className="flex w-full items-center flex-col sm:flex-row gap-[16px]">
            <div className="max-w-[116px] border-[1px] rounded-[8px] flex items-center w-full">
              <div className="flex max-w-[58px] w-full py-[7px] px-[6px] justify-center items-center  rounded-[8px] bg-[#f5f5f5]">
                <span className="text-[#171717] font-inter text-[14px] leading-normal font-[400]">
                  Image
